...
step_barbican=false
step_lbaas=false
step_autoscaling=false
step_nfv=false
step_baremetal=false
step_sahara=false
step_manila=false
...
openstack project create redhat
openstack user create --project redhat --password redhat redhat
openstack role add --user redhat --project redhat admin
