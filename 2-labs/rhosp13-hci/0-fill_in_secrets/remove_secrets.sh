...
sed -i "s/subs_activationkey:.*/subs_activationkey: SECRET/g" ../3-configure_vms/ansible/vars/ext-services/node-predeploy_vars.yaml
sed -i "s/subs_activationkey:.*/subs_activationkey: SECRET/g" ../3-configure_vms/ansible/vars/director/node-predeploy_vars.yaml
sed -i "s/rhel_reg_activation_key:.*/rhel_reg_activation_key: \"SECRET\"/g" ../3-configure_vms/config/rhosp/templates/environments/20-environment-rhel-registration.yaml
...
sed -i "s/subs_orgid:.*/subs_orgid: SECRET/g" ../3-configure_vms/ansible/vars/ext-services/node-predeploy_vars.yaml
sed -i "s/subs_orgid:.*/subs_orgid: SECRET/g" ../3-configure_vms/ansible/vars/director/node-predeploy_vars.yaml
sed -i "s/rhel_reg_org:.*/rhel_reg_org: \"SECRET\"/g" ../3-configure_vms/config/rhosp/templates/environments/20-environment-rhel-registration.yaml
...
sed -i "s/subs_pool:.*/subs_pool: SECRET/g" ../3-configure_vms/ansible/vars/ext-services/node-predeploy_vars.yaml
sed -i "s/subs_pool:.*/subs_pool: SECRET/g" ../3-configure_vms/ansible/vars/director/node-predeploy_vars.yaml
sed -i "s/rhel_reg_pool_id:.*/rhel_reg_pool_id: \"SECRET\"/g" ../3-configure_vms/config/rhosp/templates/environments/20-environment-rhel-registration.yaml
...
sed -i "s/pm_user\".*/pm_user\": \"SECRET\",/g" ../3-configure_vms/config/rhosp/instackenv.json
sed -i "s/pm_password\".*/pm_password\": \"SECRET\",/g" ../3-configure_vms/config/rhosp/instackenv.json
...
sed -i "s/ipmi_username:.*/ipmi_username: SECRET/g" ../3-configure_vms/config/rhosp/scripts/overcloud_after_deploy_test.sh
sed -i "s/ipmi_password:.*/ipmi_password: SECRET/g" ../3-configure_vms/config/rhosp/scripts/overcloud_after_deploy_test.sh
...
sed -i "s/login:.*/login: SECRET/g" ../3-configure_vms/config/rhosp/templates/environments/98-fencing.yaml
sed -i "s/passwd:.*/passwd: SECRET/g" ../3-configure_vms/config/rhosp/templates/environments/98-fencing.yaml
...
sed -i "s/vbmc_username:.*/vbmc_username: SECRET/g" ../3-configure_vms/ansible/vars/director/vbmc-config_vars.yaml
sed -i "s/vbmc_password:.*/vbmc_password: SECRET/g" ../3-configure_vms/ansible/vars/director/vbmc-config_vars.yaml



#kvm_ip=$(grep kvm_ip $secrets_file | awk -F \= '{print $2}')
#sed -i "s/libvirt_server:.*/libvirt_server: ${kvm_ip}/g" ../3-configure_vms/ansible/vars/director/vbmc-config_vars.yaml
sed -i "s/libvirt_server:.*/libvirt_server: SECRET/g" ../3-configure_vms/ansible/vars/director/vbmc-config_vars.yaml
