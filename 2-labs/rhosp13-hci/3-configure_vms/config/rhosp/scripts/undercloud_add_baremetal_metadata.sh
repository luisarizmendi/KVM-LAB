...
#openstack baremetal node set --property capabilities='profile:control,boot_option:local' $(echo $nodes | awk '{print $2}')
openstack baremetal node set --property capabilities='node:controller-1,boot_option:local' $(echo $nodes | awk '{print $2}')
openstack baremetal node set --property root_device='{"name": "/dev/vda"}' $(echo $nodes | awk '{print $2}')

#openstack baremetal node set --property capabilities='profile:control,boot_option:local' $(echo $nodes | awk '{print $3}')
openstack baremetal node set --property capabilities='node:controller-2,boot_option:local' $(echo $nodes | awk '{print $3}')
...
openstack baremetal node set --property capabilities='node:computehci-0,boot_option:local' $(echo $nodes | awk '{print $4}')
...
openstack baremetal node set --property capabilities='node:computehci-1,boot_option:local' $(echo $nodes | awk '{print $5}')
openstack baremetal node set --property root_device='{"name": "/dev/vda"}' $(echo $nodes | awk '{print $5}')

#openstack baremetal node set --property capabilities='profile:compute,boot_option:local' $(echo $nodes | awk '{print $6}')
openstack baremetal node set --property capabilities='node:computehci-2,boot_option:local' $(echo $nodes | awk '{print $6}')
openstack baremetal node set --property root_device='{"name": "/dev/vda"}' $(echo $nodes | awk '{print $6}')
